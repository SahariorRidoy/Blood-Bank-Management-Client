...
const ContactUs = () => {
    const handleContact=(e)=>{
        ...
        Swal.fire({
            ...
            text: "Our team will contact with you shortly.",
...
<section className="min-h-screen bg-cover rounded-lg " style={{ backgroundImage: `url('${contactImg}')` }}
>
    <div className="flex flex-col min-h-screen rounded-lg bg-black/60">
        <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
            <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
                <div className="text-white lg:w-1/2 lg:mx-6">
                    <h1 className="text-2xl font-semibold capitalize lg:text-3xl">Donate Blood, Save Lives</h1>

                    <p className="max-w-xl mt-6">
                    Your donation can help save lives. If you have any questions or need assistance, feel free to reach out to us. 
                    We are here to make the donation process as easy and smooth as possible for you.
                    </p>
                   ...
                   <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white opacity-90 shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                        ...
                        <form onSubmit={handleContact} className="mt-6">
                            <div className="flex-1">
                                <label className="block mb-2 text-sm text-gray-900 dark:text-gray-200">Full Name</label>
                                <input type="text" placeholder="John Doe" required className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                            </div>

                            <div className="flex-1 mt-6">
                                <label className="block mb-2 text-sm text-gray-900 dark:text-gray-200">Email address</label>
                                <input type="email" placeholder="johndoe@example.com" required className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                            </div>

                            <div className="w-full mt-6">
                                <label className="block mb-2 text-sm text-gray-900 dark:text-gray-200">Message</label>
