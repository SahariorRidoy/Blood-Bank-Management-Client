...
const Header = () => {
  return (
    <header className="bg-red-50 dark:bg-gray-900">
      ...
      <div className="flex items-center justify-center w-full px-6 py-8 lg:h-[32rem] lg:w-1/2">
        <div className="max-w-xl">
          ...
          <div className="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row">
            <Link
              to="/register"
              className="block px-5 py-2 text-sm font-medium text-center text-white transition-colors duration-300 bg-red-600 rounded-md hover:bg-red-500"
            >
              Join as a Donor
            </Link>
            <Link
              to="/search"
              className="block px-5 py-2 text-sm font-medium text-center text-black transition-colors duration-300 bg-red-200 rounded-md lg:mx-4 hover:bg-red-300"
            >
              Search Donors
            </Link>
          </div>
