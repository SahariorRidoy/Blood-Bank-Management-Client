...
const Register = () => {
  ...
  return (
    <section className="py-2 flex flex-col lg:flex-row w-full lg:w-[1320px] mx-auto mt-16 overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-900">
  {/* Left Image */}
  <div
    className="w-full mx-2 lg:w-1/2 h-64 lg:h-[85vh] bg-cover bg-center"
    style={{
  ...
  <div className="flex items-center justify-center px-6 mx-auto w-full lg:w-1/2">
    <form className="w-full max-w-md" onSubmit={handleRegister}>
      ...
      <div className="mt-6">
        <button
          type="submit"
          className="w-full px-4 lg:px-6 py-2 lg:py-3 text-sm lg:text-base font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
        >
          Register
        </button>
